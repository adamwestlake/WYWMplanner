...
def main(request):
    ...
    return render(request, 'home.html', {'name': 'Adam','num_employees': getNumberOfEmployees(), 'num_teams': getTeams(), 'form': new(request), 'user_data_by_location': user_data_by_location,})
